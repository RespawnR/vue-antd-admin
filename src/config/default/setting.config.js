...
module.exports = {
  ...
  systemName: 'Refresh',         //系统名称
  copyright: '2021 REFRESH STUDIO 出品',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://pro.ant.design', icon: 'ant-design'},
    {link: 'https://github.com/RespawnR/vue-antd-admin', icon: 'github'},
    {link: 'https://ant.design', icon: 'ant-design'}
  ],
}
